...
$string['pluginname'] = 'Interactive PDF';
$string['modulename'] = 'Interactive PDF';
$string['view_title'] = 'Interactive PDF';
$string['view_heading'] = 'Interactive PDF';
$string['attempts'] = 'Attempts';
$string['add_page'] = 'Add Page';
$string['edit_page'] = 'Edit Page';


// Lang from interactivepdf
...
/**
 * Strings for component 'interactivepdf', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package   mod_interactivepdf
...
$string['accessnoticesheader'] = 'You can preview this interactivepdf, but if this were a real attempt, you would be blocked because:';
$string['action'] = 'Action';
$string['activityoverview'] = 'You have interactivepdfzes that are due';
$string['adaptive'] = 'Adaptive mode';
$string['adaptive_help'] = 'If enabled, multiple responses to a question are allowed within the same attempt at the interactivepdf. So for example if a response is marked as incorrect, the student will be allowed to try again immediately. However, depending on the "Apply penalties" setting, a penalty will usually be subtracted for each wrong attempt.';
$string['add'] = 'Add';
$string['addaquestion'] = 'a new question';
$string['addasection'] = 'a new section heading';
$string['addarandomquestion'] = 'a random question';
$string['addarandomquestion_help'] = 'When a random question is added, it results in a randomly-chosen question from the category being inserted into the interactivepdf. This means that different students are likely to get a different selection of questions, and when a interactivepdf allows multiple attempts then each attempt is likely to contain a new selection of questions.';
...
$string['addingquestions'] = '<p>This side of the page is where you manage your database of questions. Questions are stored in categories to help you keep them organised, and can be used by any interactivepdf in your course or even other courses if you choose to \'publish\' them.</p>
<p>After you select or create a question category you will be able to create or edit questions. You can select any of these questions to add to your interactivepdf over on the other side of this page.</p>';
...
$string['addquestionstointeractivepdf'] = 'Add questions to current interactivepdf';
...
$string['addrandomquestiontointeractivepdf'] = 'Add a random question to interactivepdf {$a}';
$string['addrandom1'] = '<< Add';
$string['addrandom2'] = 'random questions';
$string['addselectedquestionstointeractivepdf'] = 'Add selected questions to the interactivepdf';
$string['addselectedtointeractivepdf'] = 'Add selected to interactivepdf';
$string['addtointeractivepdf'] = 'Add to interactivepdf';
...
$string['attempterror'] = 'You are not allowed to attempt this interactivepdf at this time because: {$a}';
$string['attempterrorinvalid'] = 'Invalid interactivepdf attempt ID';
$string['attempterrorcontentchange'] = 'This interactivepdf preview no longer exists. (When a interactivepdf is edited, any in-progress previews are automatically deleted.)';
$string['attempterrorcontentchangeforuser'] = 'This interactivepdf attempt no longer exists.';
...
$string['attemptinteractivepdfnow'] = 'Attempt interactivepdf now';
$string['attemptinteractivepdf'] = 'Attempt interactivepdf';
...
$string['attemptsdeleted'] = 'interactivepdf attempts deleted';
...
$string['autosaveperiod_desc'] = 'Responses can be saved automatically during interactivepdf attempts. The responses are saved whenever one is changed, and then after this delay. There is a trade-off: a shorter delay increases the server load, but reduces the chance that students lose their work. If you are going to make this delay much shorter, you should change the value gradually and monitor the server load. If the load gets too high, make the delay longer again. Setting the delay to 0 turns off auto-saving.';
$string['back'] = 'Back to preview question';
$string['backtocourse'] = 'Back to the course';
$string['backtoquestionlist'] = 'Back to question list';
$string['backtointeractivepdf'] = 'Back to interactivepdf editing';
...
* The interactivepdf will only start if the student has a JavaScript-enabled web-browser
* The interactivepdf appears in a full screen popup window that covers all the other windows and has no navigation controls
...
$string['cannoteditafterattempts'] = 'You cannot add or remove questions because this interactivepdf has been attempted. ({$a})';
...
$string['cannotsetgrade'] = 'Could not set a new maximum grade for the interactivepdf';
$string['cannotsetsumgrades'] = 'Failed to set sumgrades';
$string['cannotstartgradesmismatch'] = 'Cannot start an attempt at this interactivepdf. The interactivepdf is set to be graded out of {$a->grade}, but none of the questions in the interactivepdf have a grade. This can be fixed on the \'Edit interactivepdf\' page.';
$string['cannotstartmissingquestion'] = 'Cannot start an attempt at this interactivepdf. The interactivepdf definition includes a question that does not exist.';
$string['cannotstartnoquestions'] = 'Cannot start an attempt at this interactivepdf. The interactivepdf has not been set up yet. No questions have been added.';
$string['cannotwrite'] = 'Cannot write to export file ({$a})';
$string['canredoquestions'] = 'Allow redo within an attempt';
$string['canredoquestions_desc'] = 'If enabled, after finishing attempting a question, a \'Try another question like this one\' button is displayed. This allows for a similar question (selected randomly) to be attempted, or the same question again, without the entire interactivepdf attempt having to be submitted and another attempt started. This option is useful for practice interactivepdfzes.
...
$string['closebeforeopen'] = 'Could not update the interactivepdf. You have specified a close date before the open date.';
...
$string['completionattemptsexhausted_help'] = 'Mark interactivepdf complete when the student has exhausted the maximum number of attempts.';
$string['configadaptive'] = 'If you choose Yes for this option then the student will be allowed multiple responses to a question even within the same attempt at the interactivepdf.';
$string['configattemptsallowed'] = 'Restriction on the number of attempts students are allowed at the interactivepdf.';
$string['configdecimaldigits'] = 'Number of digits that should be shown after the decimal point when displaying grades.';
$string['configdecimalplaces'] = 'Number of digits that should be shown after the decimal point when displaying grades for the interactivepdf.';
...
$string['configdelay1'] = 'If you set a time delay, then a student has to wait for that time before they can attempt a interactivepdf after the first attempt.';
...
$string['configgrademethod'] = 'When multiple attempts are allowed, which method should be used to calculate the student\'s final grade for the interactivepdf.';
$string['configintro'] = 'The values you set here define the default values that are used in the settings form when you create a new interactivepdf. You can also configure which interactivepdf settings are considered advanced.';
$string['configmaximumgrade'] = 'The default grade that the interactivepdf grade is scaled to be out of.';
$string['confignewpageevery'] = 'When adding questions to the interactivepdf page breaks will automatically be inserted according to the setting you choose here.';
...
$string['configoutcomesadvanced'] = 'If this option is turned on, then the Outcomes on the interactivepdf editing form are advanced settings.';
$string['configpenaltyscheme'] = 'Penalty subtracted for each wrong response in adaptive mode.';
$string['configpopup'] = 'Force the attempt to open in a popup window, and use JavaScript tricks to try to restrict copy and paste, etc. during interactivepdf attempts.';
$string['configrequirepassword'] = 'Students must enter this password before they can attempt the interactivepdf.';
$string['configrequiresubnet'] = 'Students can only attempt the interactivepdf from these computers.';
$string['configreviewoptions'] = 'These options control what information users can see when they review a interactivepdf attempt or look at the interactivepdf reports.';
$string['configshowblocks'] = 'Show blocks during interactivepdf attempts.';
$string['configshowuserpicture'] = 'Show the user\'s picture on screen during attempts.';
$string['configshufflewithin'] = 'If you enable this option, then the parts making up the individual questions will be randomly shuffled each time a student starts an attempt at this interactivepdf, provided the option is also enabled in the question settings.';
$string['configtimelimit'] = 'Default time limit for interactivepdfzes in minutes. 0 mean no time limit.';
$string['configtimelimitsec'] = 'Default time limit for interactivepdfzes in seconds. 0 mean no time limit.';
...
$string['continueattemptinteractivepdf'] = 'Continue your attempt';
...
$string['countdownfinished'] = 'The interactivepdf is closing, you should submit your answers now.';
$string['countdowntenminutes'] = 'The interactivepdf will be closing in ten minutes.';
...
$string['createmultiple'] = 'Add several random questions to interactivepdf';
$string['createnewquestion'] = 'Create new question';
$string['createquestionandadd'] = 'Create a new question and add it to the interactivepdf.';
...
$string['delaylater_help'] = 'If enabled, a student must wait for the specified time to elapse before attempting the interactivepdf a third time and any subsequent times.';
$string['delay1'] = 'Time delay between first and second attempt';
$string['delay1st2nd'] = 'Enforced delay between 1st and 2nd attempts';
$string['delay1st2nd_help'] = 'If enabled, a student must wait for the specified time to elapse before being able to attempt the interactivepdf a second time.';
...
$string['downloadextra'] = '(file is also stored in the course files in the /backupdata/interactivepdf folder)';
...
$string['eachattemptbuildsonthelast_help'] = 'If multiple attempts are allowed and this setting is enabled, each new interactivepdf attempt will contain the results of the previous attempt. This allows a interactivepdf to be completed over several attempts.';
...
$string['editinginteractivepdf'] = 'Editing interactivepdf';
$string['editinginteractivepdf_help'] = 'When creating a interactivepdf, the main concepts are:

* The interactivepdf, containing questions over one or more pages
* The question bank, which stores copies of all questions organised into categories
* Random questions -  A student gets different questions each time they attempt the interactivepdf and different students can get different questions';
$string['editinginteractivepdf_link'] = 'mod/interactivepdf/edit';
$string['editinginteractivepdfx'] = 'Editing interactivepdf: {$a}';
...
$string['editinteractivepdf'] = 'Edit interactivepdf';
$string['editinteractivepdfquestions'] = 'Edit interactivepdf questions';
$string['emailconfirmbody'] = 'Hi {$a->username},

Thank you for submitting your answers to \'{$a->interactivepdfname}\' in course \'{$a->coursename}\' at {$a->submissiontime}.

This message confirms that your answers have been saved.

You can access this interactivepdf at {$a->interactivepdfurl}.';
$string['emailconfirmbodyautosubmit'] = 'Hi {$a->username},

The time for the interactivepdf \'{$a->interactivepdfname}\' in the course \'{$a->coursename}\' expired. Your answers were submitted automatically at {$a->submissiontime}.

This message confirms that your answers have been saved.

You can access this interactivepdf at {$a->interactivepdfurl}.';
$string['emailconfirmsmall'] = 'Thank you for submitting your answers to \'{$a->interactivepdfname}\'';
$string['emailconfirmautosubmitsmall'] = 'Thank you for submitting your answers to \'{$a->interactivepdfname}\'';
$string['emailconfirmsubject'] = 'Submission confirmation: {$a->interactivepdfname}';
$string['emailnotifybody'] = 'Hi {$a->username},

{$a->studentname} has completed \'{$a->interactivepdfname}\' ({$a->interactivepdfurl}) in course \'{$a->coursename}\'.

You can review this attempt at {$a->interactivepdfreviewurl}.';
$string['emailnotifysmall'] = '{$a->studentname} has completed {$a->interactivepdfname}. See {$a->interactivepdfreviewurl}';
$string['emailnotifysubject'] = '{$a->studentname} has completed {$a->interactivepdfname}';
$string['emailmanualgradedbody'] = 'Hi {$a->studentname},

Your answers to \'{$a->interactivepdfname}\' in course \'{$a->coursename}\' at {$a->attempttimefinish} have now been graded.

You will be able to view your score and feedback by visiting \'{$a->interactivepdfurl}\' and reviewing your attempt.';

$string['emailmanualgradedsubject'] = 'Your attempt at {$a->interactivepdfname} has been graded';
$string['emailoverduebody'] = 'Hi {$a->studentname},

You started an attempt at \'{$a->interactivepdfname}\' in course \'{$a->coursename}\', but you never submitted it. It should have been submitted by {$a->attemptduedate}.
...
$string['emailoverduesmall'] = 'You did not submit your attempt at {$a->interactivepdfname}. Please go to {$a->attemptsummaryurl} before {$a->attemptgraceend} if you would still like to submit.';
$string['emailoverduesubject'] = 'Attempt now overdue: {$a->interactivepdfname}';
$string['empty'] = 'Empty';
...
$string['eventattemptautosaved'] = 'interactivepdf attempt auto-saved';
$string['eventattemptdeleted'] = 'interactivepdf attempt deleted';
$string['eventattemptmanualgradingcomplete'] = 'interactivepdf attempt manual grading complete';
$string['eventattemptpreviewstarted'] = 'interactivepdf attempt preview started';
$string['eventattemptquestionrestarted'] = 'interactivepdf attempt question restarted';
$string['eventattemptreviewed'] = 'interactivepdf attempt reviewed';
$string['eventattemptsummaryviewed'] = 'interactivepdf attempt summary viewed';
$string['eventattemptupdated'] = 'interactivepdf attempt updated';
$string['eventattemptviewed'] = 'interactivepdf attempt viewed';
$string['eventeditpageviewed'] = 'interactivepdf edit page viewed';
$string['eventoverridecreated'] = 'interactivepdf override created';
$string['eventoverridedeleted'] = 'interactivepdf override deleted';
$string['eventoverrideupdated'] = 'interactivepdf override updated';
...
$string['eventinteractivepdfattemptabandoned'] = 'interactivepdf attempt abandoned';
$string['eventinteractivepdfattemptregraded'] = 'interactivepdf attempt regraded';
$string['eventinteractivepdfattemptreopened'] = 'interactivepdf attempt reopened';
$string['eventinteractivepdfattemptstarted'] = 'interactivepdf attempt started';
$string['eventinteractivepdfattemptsubmitted'] = 'interactivepdf attempt submitted';
$string['eventinteractivepdfattempttimelimitexceeded'] = 'interactivepdf attempt time limit exceeded';
$string['eventinteractivepdfgradeupdated'] = 'interactivepdf grade updated';
$string['eventinteractivepdfrepaginated'] = 'interactivepdf re-paginated';
$string['eventreportviewed'] = 'interactivepdf report viewed';
...
$string['graceperiodmin_desc'] = 'There is a potential problem right at the end of the interactivepdf. On the one hand, we want to let students continue working right up until the last second - with the help of the timer that automatically submits the interactivepdf when time runs out. On the other hand, the server may then be overloaded, and take some time to get to process the responses. Therefore, we will accept responses for up to this long after time expires, so they are not penalised for the server being slow. However, the student could cheat and get this many seconds to answer the interactivepdf. You have to make a trade-off based on how much you trust the performance of your server during interactivepdfzes.';
...
$string['grademethod_help'] = 'When multiple attempts are allowed, the following methods are available for calculating the final interactivepdf grade:

* Highest grade of all attempts
* Average (mean) grade of all attempts
* First attempt (all other attempts are ignored)
* Last attempt (all other attempts are ignored)';
$string['gradesdeleted'] = 'interactivepdf grades deleted';
$string['gradesofar'] = '{$a->method}: {$a->mygrade} / {$a->interactivepdfgrade}.';
$string['gradetopassmustbeset'] = 'Grade to pass cannot be zero as this interactivepdf has its completion method set to require passing grade. Please set a non-zero value.';
...
$string['guestsno'] = 'Sorry, guests cannot see or attempt interactivepdfzes';
$string['hidebreaks'] = 'Hide page breaks';
$string['hidereordertool'] = 'Hide the reordering tool';
$string['history'] = 'History of responses:';
$string['howquestionsbehave_desc'] = 'Default setting for how questions behave in a interactivepdf.';
...
$string['indicator:cognitivedepth'] = 'interactivepdf cognitive';
$string['indicator:cognitivedepth_help'] = 'This indicator is based on the cognitive depth reached by the student in a interactivepdf activity.';
$string['indicator:cognitivedepthdef'] = 'interactivepdf cognitive';
$string['indicator:cognitivedepthdef_help'] = 'The participant has reached this percentage of the cognitive engagement offered by the interactivepdf activities during this analysis interval (Levels = No view, View, Submit, View feedback, Comment on feedback, Resubmit after viewing feedback)';
$string['indicator:cognitivedepthdef_link'] = 'Learning_analytics_indicators#Cognitive_depth';
$string['indicator:socialbreadth'] = 'interactivepdf social';
$string['indicator:socialbreadth_help'] = 'This indicator is based on the social breadth reached by the student in a interactivepdf activity.';
$string['indicator:socialbreadthdef'] = 'interactivepdf social';
$string['indicator:socialbreadthdef_help'] = 'The participant has reached this percentage of the social engagement offered by the interactivepdf activities during this analysis interval (Levels = No participation, Participant alone, Participant with others)';
...
$string['initialnumfeedbacks_desc'] = 'When creating a new interactivepdf, provide this many blank overall feedback boxes. Once the interactivepdf has been created, the form shows the number of fields required for the number of feedbacks in the interactivepdf. The setting must be at least 1.';
...
$string['invalidinteractivepdfid'] = 'Invalid interactivepdf ID';
...
$string['legacyinteractivepdfaccessrulescron'] = 'Legacy cron interactivepdf access rules';
$string['legacyinteractivepdfreportscron'] = 'Legacy cron interactivepdf reports';
$string['link'] = 'Link';
$string['listitems'] = 'Listing of items in interactivepdf';
...
$string['manualgradequestion'] = 'Manually grade question {$a->question} in {$a->interactivepdf} by {$a->user}';
$string['mark'] = 'Submit';
...
$string['messageprovider:attempt_overdue'] = 'Warning when your interactivepdf attempt becomes overdue';
$string['messageprovider:confirmation'] = 'Confirmation of your own interactivepdf submissions';
$string['messageprovider:attempt_grading_complete'] = 'Notification that your attempt has been graded';
$string['messageprovider:submission'] = 'Notification of your students\' interactivepdf submissions';
$string['max'] = 'Max';
...
$string['modulename'] = 'interactivepdf';
$string['modulename_help'] = 'The interactivepdf activity enables a teacher to create interactivepdfzes comprising questions of various types, including multiple choice, matching, short-answer and numerical.

The teacher can allow the interactivepdf to be attempted multiple times, with the questions shuffled or randomly selected from the question bank. A time limit may be set.
...
* For self-assessment';
$string['modulename_link'] = 'mod/interactivepdf/view';
$string['modulenameplural'] = 'interactivepdfzes';
...
$string['navmethod_help'] = 'When sequential navigation is enabled a student must progress through the interactivepdf in order and may not return to previous pages nor skip ahead.';
...
$string['newattemptfail'] = 'Error: Could not start a new attempt at the interactivepdf';
$string['newcategory'] = 'New category';
$string['newpage'] = 'New page';
$string['newpage_help'] = 'For longer interactivepdfzes it makes sense to stretch the interactivepdf over several pages by limiting the number of questions per page. When adding questions to the interactivepdf, page breaks will automatically be inserted according to this setting. However page breaks may later be moved manually on the editing page.';
...
$string['noattempts'] = 'No attempts have been made on this interactivepdf';
...
$string['nogradewarning'] = 'This interactivepdf is not graded, so you cannot set overall feedback that differs by grade.';
$string['nomoreattempts'] = 'No more attempts are allowed';
$string['none'] = 'None';
$string['noopen'] = 'No open date';
$string['nooverridedata'] = 'You must override at least one of the interactivepdf settings.';
...
$string['noquestionsininteractivepdf'] = 'There are no questions in this interactivepdf.';
...
$string['noreview'] = 'You are not allowed to review this interactivepdf';
$string['noreviewattempt'] = 'You are not allowed to review this attempt.';
$string['noreviewshort'] = 'Not permitted';
$string['noreviewuntil'] = 'You are not allowed to review this interactivepdf until {$a}';
$string['noreviewuntilshort'] = 'Available {$a}';
$string['noscript'] = 'JavaScript must be enabled to continue!';
$string['notavailabletostudents'] = 'Note: This interactivepdf is currently not available to your students.';
...
$string['notifyattemptsgradedtask'] = 'Send interactivepdf attempt graded notifications';
$string['notimedependentitems'] = 'Time dependent items are not currently supported by the interactivepdf module. As a work around, set a time limit for the whole interactivepdf. Do you wish to choose a different item (or use the current item regardless)?';
$string['notyetgraded'] = 'Not yet graded';
$string['notyetviewed'] = 'Not yet viewed';
$string['notyourattempt'] = 'This is not your attempt!';
$string['noview'] = 'Logged-in user is not allowed to view this interactivepdf';
...
$string['openafterclose'] = 'Could not update the interactivepdf. You have specified an open date after the close date.';
$string['openclosedatesupdated'] = 'interactivepdf open and close dates updated';
...
$string['orderinginteractivepdf'] = 'Order and paging';
$string['orderinginteractivepdfx'] = 'Order and paging: {$a}';
...
$string['overallfeedback_help'] = 'Overall feedback is text that is shown after a interactivepdf has been attempted. By specifying additional grade boundaries (as a percentage or as a number), the text shown can depend on the grade obtained.';
$string['overdue'] = 'Overdue';
$string['overduehandling'] = 'When time expires';
$string['overduehandling_desc'] = 'What should happen by default if a student does not submit the interactivepdf before time expires.';
$string['overduehandling_help'] = 'This setting controls what happens if a student fails to submit their interactivepdf attempt before the time expires. If the student is actively working on the interactivepdf at the time, then the countdown timer will always automatically submit the attempt for them, but if they have logged out, then this setting controls what happens.';
$string['overduehandling_link'] = 'mod/interactivepdf/timing';
...
$string['overduemustbesubmittedby'] = 'This attempt is now overdue. It should already have been submitted. If you would like this interactivepdf to be graded, you must submit it by {$a}. If you do not submit it by then, no marks from this attempt will be counted.';
...
$string['overridegroupeventname'] = '{$a->interactivepdf} - {$a->group}';
$string['overrides'] = 'Overrides';
$string['overridesforinteractivepdf'] = 'Settings overrides: {$a}';
$string['overridesnoneforgroups'] = 'No group settings overrides have been created for this interactivepdf.';
$string['overridesnoneforusers'] = 'No user settings overrides have been created for this interactivepdf.';
...
$string['overrideusereventname'] = '{$a->interactivepdf} - Override';
$string['pageshort'] = 'P';
$string['page-mod-interactivepdf-x'] = 'Any interactivepdf module page';
$string['page-mod-interactivepdf-attempt'] = 'Attempt interactivepdf page';
$string['page-mod-interactivepdf-edit'] = 'Edit interactivepdf page';
$string['page-mod-interactivepdf-report'] = 'Any interactivepdf report page';
$string['page-mod-interactivepdf-review'] = 'Review interactivepdf attempt page';
$string['page-mod-interactivepdf-summary'] = 'interactivepdf attempt summary page';
$string['page-mod-interactivepdf-view'] = 'interactivepdf information page';
...
$string['pluginadministration'] = 'interactivepdf administration';
$string['pluginname'] = 'interactivepdf';
$string['popup'] = 'Show interactivepdf in a \'secure\' window';
$string['popupblockerwarning'] = 'This section of the test is in secure mode, this means that you need to take the interactivepdf in a secure window. Please turn off your popup blocker. Thank you.';
$string['popupnotice'] = 'Students will see this interactivepdf in a secure window';
$string['preprocesserror'] = 'Error occurred during pre-processing!';
$string['preview'] = 'Preview';
$string['previewquestion'] = 'Preview question';
$string['previewinteractivepdf'] = 'Preview {$a}';
$string['previewinteractivepdfstart'] = 'Preview interactivepdf';
$string['previewinteractivepdfnow'] = 'Preview interactivepdf now';
$string['previous'] = 'Previous state';
$string['privacy:metadata:core_question'] = 'The interactivepdf activity stores question usage information in the core_question subsystem.';
$string['privacy:metadata:interactivepdf'] = 'The interactivepdf activity makes use of interactivepdf reports.';
$string['privacy:metadata:interactivepdf_attempts'] = 'Details about each attempt on a interactivepdf.';
$string['privacy:metadata:interactivepdf_attempts:attempt'] = 'The attempt number.';
$string['privacy:metadata:interactivepdf_attempts:currentpage'] = 'The current page that the user is on.';
$string['privacy:metadata:interactivepdf_attempts:gradednotificationsenttime'] = 'The time the user was notified that manual grading of their attempt was complete';
$string['privacy:metadata:interactivepdf_attempts:preview'] = 'Whether this is a preview of the interactivepdf.';
$string['privacy:metadata:interactivepdf_attempts:state'] = 'The current state of the attempt.';
$string['privacy:metadata:interactivepdf_attempts:sumgrades'] = 'The sum of grades in the attempt.';
$string['privacy:metadata:interactivepdf_attempts:timecheckstate'] = 'The time that the state was checked.';
$string['privacy:metadata:interactivepdf_attempts:timefinish'] = 'The time that the attempt was completed.';
$string['privacy:metadata:interactivepdf_attempts:timemodified'] = 'The time that the attempt was updated.';
$string['privacy:metadata:interactivepdf_attempts:timemodifiedoffline'] = 'The time that the attempt was updated via an offline update.';
$string['privacy:metadata:interactivepdf_attempts:timestart'] = 'The time that the attempt was started.';
$string['privacy:metadata:interactivepdf_grades'] = 'Details about the overall grade for this interactivepdf.';
$string['privacy:metadata:interactivepdf_grades:grade'] = 'The overall grade for this interactivepdf.';
$string['privacy:metadata:interactivepdf_grades:interactivepdf'] = 'The interactivepdf that was graded.';
$string['privacy:metadata:interactivepdf_grades:timemodified'] = 'The time that the grade was modified.';
$string['privacy:metadata:interactivepdf_grades:userid'] = 'The user who was graded.';
$string['privacy:metadata:interactivepdf_overrides'] = 'Details about overrides for this interactivepdf';
$string['privacy:metadata:interactivepdf_overrides:interactivepdf'] = 'The interactivepdf with override information';
$string['privacy:metadata:interactivepdf_overrides:timeclose'] = 'The new close time for the interactivepdf.';
$string['privacy:metadata:interactivepdf_overrides:timelimit'] = 'The new time limit for the interactivepdf.';
$string['privacy:metadata:interactivepdf_overrides:timeopen'] = 'The new open time for the interactivepdf.';
$string['privacy:metadata:interactivepdf_overrides:userid'] = 'The user being overridden';
$string['privacy:metadata:interactivepdfaccess'] = 'The interactivepdf activity makes use of interactivepdf access rules.';
...
$string['questiondraftonly'] = 'The question {$a} is in draft status. To use it in the interactivepdf, go to the question bank and change the status to ready.';
$string['questiondraftwillnotwork'] = 'This question is in draft status. To use it in the interactivepdf, go to the question bank and change the status to ready.';
$string['questioninuse'] = 'The question \'{$a->questionname}\' is currently being used in: <br />{$a->interactivepdfnames}<br />The question will not be deleted from these interactivepdfzes but only from the category list.';
...
$string['questionsinthisinteractivepdf'] = 'Questions in this interactivepdf';
...
$string['interactivepdf:addinstance'] = 'Add a new interactivepdf';
$string['interactivepdf:attempt'] = 'Attempt interactivepdfzes';
$string['interactivepdfavailable'] = 'The interactivepdf is available until: {$a}';
$string['interactivepdfclose'] = 'Close the interactivepdf';
$string['interactivepdfclosed'] = 'This interactivepdf closed on {$a}';
$string['interactivepdfcloses'] = 'interactivepdf closes';
$string['interactivepdfeventcloses'] = '{$a} closes';
$string['interactivepdfcloseson'] = 'This interactivepdf will close on {$a}.';
$string['interactivepdf:deleteattempts'] = 'Delete interactivepdf attempts';
$string['interactivepdf:emailconfirmsubmission'] = 'Receive confirmation of your own interactivepdf submissions';
$string['interactivepdf:emailnotifysubmission'] = 'Receive notification of your students\' interactivepdf submissions';
$string['interactivepdf:emailnotifyattemptgraded'] = 'Receive notification when your attempt has been graded';
$string['interactivepdf:emailwarnoverdue'] = 'Receive warning when your interactivepdf attempt becomes overdue';
$string['interactivepdf:grade'] = 'Grade interactivepdfzes manually';
$string['interactivepdf:ignoretimelimits'] = 'Ignore interactivepdf time limit';
$string['interactivepdfisclosed'] = 'This interactivepdf is closed';
$string['interactivepdfisopen'] = 'This interactivepdf is open';
$string['interactivepdfisclosedwillopen'] = 'interactivepdf closed (opens {$a})';
$string['interactivepdfisopenwillclose'] = 'interactivepdf open (closes {$a})';
$string['interactivepdf:manage'] = 'Manage interactivepdfzes';
$string['interactivepdf:manageoverrides'] = 'Manage interactivepdf settings overrides';
$string['interactivepdf:viewoverrides'] = 'View interactivepdf settings overrides';
$string['interactivepdfnavigation'] = 'interactivepdf navigation';
$string['interactivepdfopen'] = 'Open the interactivepdf';
$string['interactivepdfeventopens'] = '{$a} opens';
$string['interactivepdfopenclose'] = 'Open and close dates';
$string['interactivepdfopenclose_help'] = 'Students can only start their attempt(s) after the open time and they must complete their attempts before the close time.';
$string['interactivepdfopenclose_link'] = 'mod/interactivepdf/timing';
$string['interactivepdfopened'] = 'This interactivepdf is open.';
$string['interactivepdfopenedon'] = 'This interactivepdf opened on {$a}';
$string['interactivepdfopens'] = 'interactivepdf opens';
$string['interactivepdfopenwillclose'] = 'This interactivepdf is open, will close on {$a} at';
$string['interactivepdfordernotrandom'] = 'Order of interactivepdf not shuffled';
$string['interactivepdforderrandom'] = '* Order of interactivepdf is shuffled';
$string['interactivepdf:preview'] = 'Preview interactivepdfzes';
$string['interactivepdf:regrade'] = 'Regrade interactivepdf attempts';
$string['interactivepdf:reopenattempts'] = 'Reopen never submitted interactivepdf attempts';
$string['interactivepdfreport'] = 'interactivepdf report';
$string['interactivepdf:reviewmyattempts'] = 'Review your own attempts';
$string['interactivepdfsettings'] = 'interactivepdf settings';
$string['interactivepdf:view'] = 'View interactivepdf information';
$string['interactivepdf:viewreports'] = 'View interactivepdf reports';
$string['interactivepdftimer'] = 'interactivepdf Timer';
$string['interactivepdfwillopen'] = 'This interactivepdf will open {$a}';
...
$string['readytosend'] = 'You are about to send your whole interactivepdf to be graded.  Are you sure you want to continue?';
$string['reattemptinteractivepdf'] = 'Re-attempt interactivepdf';
...
$string['regradenotallowed'] = 'You do not have permission to regrade this interactivepdf';
$string['regradingquestion'] = 'Regrading "{$a}".';
$string['regradinginteractivepdf'] = 'Regrading interactivepdf "{$a}"';
$string['remove'] = 'Remove';
$string['removeallgroupoverrides'] = 'Delete all group overrides';
$string['removeallinteractivepdfattempts'] = 'Delete all interactivepdf attempts';
...
$string['reopenedattemptwillbeinprogressuntil'] = 'The attempt will remain open and can be continued until the interactivepdf closes on {$a}.';
...
$string['reportusersall'] = 'all users who have attempted the interactivepdf';
$string['reportuserswith'] = 'enrolled users who have attempted the interactivepdf';
$string['reportuserswithorwithout'] = 'enrolled users who have, or have not, attempted the interactivepdf';
$string['reportuserswithout'] = 'enrolled users who have not attempted the interactivepdf';
$string['reportwhattoinclude'] = 'What to include in the report';
$string['requirepassword'] = 'Require password';
$string['requirepassword_help'] = 'If a password is specified, a student must enter it in order to attempt the interactivepdf.';
$string['requiresubnet'] = 'Require network address';
$string['requiresubnet_help'] = 'interactivepdf access may be restricted to particular subnets on the LAN or Internet by specifying a comma-separated list of partial or full IP address numbers. This can be useful for an invigilated (proctored) interactivepdf, to ensure that only people in a certain location can access the interactivepdf.';
$string['response'] = 'Response';
$string['responses'] = 'Responses';
$string['results'] = 'Results';
$string['returnattempt'] = 'Return to attempt';
$string['reuseifpossible'] = 'reuse previously removed';
$string['reverttodefaults'] = 'Revert to interactivepdf defaults';
$string['review'] = 'Review';
$string['reviewafter'] = 'Allow review after interactivepdf is closed';
$string['reviewalways'] = 'Allow review at any time';
$string['reviewattempt'] = 'Review attempt';
$string['reviewbefore'] = 'Allow review while interactivepdf is open';
$string['reviewclosed'] = 'After the interactivepdf is closed';
...
$string['reviewofquestion'] = 'Review of question {$a->question} in {$a->interactivepdf} by {$a->user}';
$string['reviewopen'] = 'Later, while the interactivepdf is still open';
$string['reviewoptions'] = 'Students may review';
$string['reviewoptionsheading'] = 'Review options';
$string['reviewoptionsheading_help'] = 'These options control what information students can see when they review a interactivepdf attempt or look at the interactivepdf reports.
...
**Later, while the interactivepdf is still open** settings apply after this, and before the interactivepdf close date.

**After the interactivepdf is closed** settings apply after the interactivepdf close date has passed. If the interactivepdf does not have a close date, this state is never reached.';
...
$string['saveattemptfailed'] = 'Failed to save the current interactivepdf attempt.';
...
$string['saveinteractivepdf'] = 'Save this whole interactivepdf';
...
$string['search:activity'] = 'interactivepdf - activity information';
...
$string['showblocks'] = 'Show blocks during interactivepdf attempts';
$string['showblocks_help'] = 'If set to yes then normal blocks will be shown during interactivepdf attempts';
...
$string['shufflequestions_help'] = 'If enabled, every time the interactivepdf is attempted, the order of the questions in this section will be shuffled into a different random order.
...
$string['shufflewithin_help'] = 'If enabled, the parts making up each question will be randomly shuffled each time a student attempts the interactivepdf, provided the option is also enabled in the question settings. This setting only applies to questions that have multiple parts, such as multiple choice or matching questions.';
...
$string['specificquestionnotoninteractivepdf'] = 'Specified question is not on the specified interactivepdf';
...
$string['subneterror'] = 'Sorry, this interactivepdf has been locked so that it is only accessible from certain locations.  Currently your computer is not one of those allowed to use this interactivepdf.';
$string['subnetnotice'] = 'This interactivepdf has been locked so that it is only accessible from certain locations. Your computer is not on an allowed subnet. As teacher you are allowed to preview anyway.';
$string['subplugintype_interactivepdf'] = 'Report';
$string['subplugintype_interactivepdf_plural'] = 'Reports';
$string['subplugintype_interactivepdfaccess'] = 'Access rule';
$string['subplugintype_interactivepdfaccess_plural'] = 'Access rules';
...
$string['temporaryblocked'] = 'You are temporarily not allowed to re-attempt the interactivepdf.<br /> You will be able to take another attempt on:';
$string['theattempt'] = 'The attempt';
$string['theattempt_help'] = 'Whether the student can review the attempt at all.';
$string['time'] = 'Time';
$string['timecompleted'] = 'Completed';
$string['timedelay'] = 'You are not allowed to do the interactivepdf since you have not passed the time delay before attempting another interactivepdf';
$string['timeleft'] = 'Time left';
$string['timelimit'] = 'Time limit';
$string['timelimit_help'] = 'If enabled, the time limit is stated on the initial interactivepdf page and a countdown timer is displayed in the interactivepdf navigation block.';
$string['timelimit_link'] = 'mod/interactivepdf/timing';
$string['timelimitexeeded'] = 'Sorry! interactivepdf time limit exceeded!';
...
$string['updateoverdueattemptstask'] = 'Updating overdue interactivepdf attempts';
$string['updatesettings'] = 'Update interactivepdf settings';
$string['updateinteractivepdfslotswithrandomxofy'] = 'Updating interactivepdf slots with "random" question data ({$a->done}/{$a->total})';
...
$string['upgradesure'] = '<div>In particular the interactivepdf module will perform an extensive change of the interactivepdf tables and this upgrade has not yet been sufficiently tested. You are very strongly urged to backup your database tables before proceeding.</div>';
$string['upgradinginteractivepdfattempts'] = 'Upgrading interactivepdf attempts: interactivepdf {$a->done}/{$a->outof} (interactivepdf id {$a->info})';
$string['upgradingveryoldinteractivepdfattempts'] = 'Upgrading very old interactivepdf attempts: {$a->done}/{$a->outof}';
$string['url'] = 'URL';
...
$string['usersnone'] = 'No students have access to this interactivepdf';
$string['validate'] = 'Validate';
$string['viewallanswers'] = 'View {$a} interactivepdf attempts';
...
$string['xhtml'] = 'XHTML';
$string['youneedtoenrol'] = 'You need to enrol in this course before you can attempt this interactivepdf';
$string['yourfinalgradeis'] = 'Your final grade for this interactivepdf is {$a}.';
$string['questionversion'] = 'v{$a}';
$string['questionversionlatest'] = 'v{$a} (latest)';
$string['alwayslatest'] = 'Always latest';
$string['gobacktointeractivepdf'] = 'Go back';
...
$string['completionpass_help'] = 'If enabled, this activity is considered complete when the student receives a pass grade (as specified in the Grade section of the interactivepdf settings) or higher.';
$string['completiondetail:passgrade'] = 'Receive a pass grade';
$string['gradetopassnotset'] = 'This interactivepdf does not yet have a grade to pass set. It may be set in the Grade section of the interactivepdf settings.';
$string['basicideasofinteractivepdf'] = 'The basic ideas of interactivepdf-making';