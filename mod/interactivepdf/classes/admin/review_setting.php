...
/**
 * Admin settings class for the interactivepdf review options.
 *
...
class review_setting extends \admin_setting {
    ...
    /**
     * This should match {@link mod_interactivepdf_mod_form::$reviewfields} but copied
     * here because generating the admin tree needs to be fast.
     * @return array
     */
    public static function fields() {
        return [
            'attempt'          => get_string('theattempt', 'interactivepdf'),
            ...
            'overallfeedback'  => get_string('overallfeedback', 'interactivepdf'),
        ];
    }
    ...
    protected static function times() {
        return [
            self::DURING            => get_string('reviewduring', 'interactivepdf'),
            self::IMMEDIATELY_AFTER => get_string('reviewimmediately', 'interactivepdf'),
            self::LATER_WHILE_OPEN  => get_string('reviewopen', 'interactivepdf'),
            self::AFTER_CLOSE       => get_string('reviewclosed', 'interactivepdf'),
        ];
    }
    ...
    public function output_html($data, $query = '') {
        ...
        return format_admin_setting($this, $this->visiblename, $return,
                $this->description, true, '', get_string('everythingon', 'interactivepdf'), $query);
    }
}
