...
$PAGE->set_url('/mod/interactivepdf/multi_question.php', array('id' => $id, 'pageid' => $pageid, 'questionid' => $questionid));
$PAGE->set_title("Interactive PDF - 2*n Multi Table");

$form = new multi_question(new moodle_url('/mod/interactivepdf/adminpages/multi_question.php', array('id' => $id, 'pageid' => $pageid, 'questionid' => $questionid)));
...
elseif ($data = $form->get_data()){
    ...
    $DB->insert_record('interactivepdf_2nms', $tableRecord);
